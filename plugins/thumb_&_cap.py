...
async def add_caption(client, message):
    ...
    await message.reply_text("__**✅ Cᴀᴩᴛɪᴏɴ Sᴀᴠᴇᴅ**__", reply_to_message_id=message.message_id)
...
async def addthumbs(client, message):
    SnowDev = await message.reply_text("Please Wait ...", reply_to_message_id=message.message_id)
